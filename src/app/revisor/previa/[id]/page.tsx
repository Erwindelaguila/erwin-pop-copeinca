...
export default function RevisorPreviaPage() {
    ...
    dispatch({
      ...
      payload: {
        ...
        entry: {
          ...
          detalles: "Documento reservado para revisión detallada",
        },
      },
    })
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/revisor")} className="bg-[#00363B] hover:bg-[#00363B]/90">
