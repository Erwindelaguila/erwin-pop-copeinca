...
export default function ValidadorPreviaPage() {
    ...
    dispatch({
      ...
      payload: {
        ...
        entry: {
          ...
          detalles: "Documento reservado para validación",
        },
      },
    })

    toast.success("Documento reservado", {
      description: "El documento ha sido enviado a sus tareas para validación",
    })
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/validador")} className="bg-[#00363B] hover:bg-[#00363B]/90">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-xl font-semibold text-gray-900">Vista Previa del Documento</h1>
              </div>
            </div>
            <div className="flex items-center space-x-3">
