...
export default function ElaboradorPreviaPage() {
  ...
  const handleReservar = () => {
    ...
    toast.success("Documento reservado", {
      description: "El documento ha sido enviado a sus tareas",
    })
    router.push("/elaborador")
  }
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Button
                variant="ghost"
                onClick={() => router.push("/elaborador")}
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  <p className="text-gray-800 leading-relaxed whitespace-pre-wrap">{document.comentariosRevisor}</p>
                </div>
              </CardContent>
            </Card>
          )}
